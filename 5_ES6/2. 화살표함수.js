...
const declareFn1 = (a,b) => {return a*b}; // return이랑 {}는 한 몸
const declareFn2 = (a,b) => a*b;
const declareFn3 = a => a; // 매개변수가 하나인 경우 ()도 생략

// 2. this 바인딩
//  - this는 모든 함수에 묵시적으로 존재하는 예약어
//  - 함수를 호출한 객체의 "주소값"이 바인딩 되도록 설게되어 있다.

function callableFn(){
    console.log(this);
}
callableFn(); // 함수 호출의 주체가 없으므로 global
...
const obj3 = {
    ...
    arrowFn : function(){
        ...
        console.log(this.name); // 1. obj3.name = 객체3
        ...
        console.log(getName2()); // 3. global의 name -> undefined
    }
};
obj3.arrowFn();
