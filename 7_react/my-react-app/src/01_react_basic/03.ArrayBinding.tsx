...
export default function ArrayDataBinding(){
    const [fruit, setFruit] = useState([{id:1,name:'apple'},{id:2,name:'banana'},{id:3,name:'cherry'}]);
            ...
            <ul>
                {
                    /*
                        #1 배열데이터 바인딩
                        map()
                         - 배열의 각 요소에 대해 함수를 호출하여 새로운 요소로 변경하여 반환하는 함수
