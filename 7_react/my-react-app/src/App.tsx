...
import AxiosGet from './02_react_advanced/04.Axios_GET'
import AxiosPost from './02_react_advanced/04.Axios_POST'
import Header from './01_react_basic/Header'
import { Link, Route, Routes } from 'react-router-dom'
import NestedRoute from './02_react_advanced/06.Nested_Route'
import { UserDetail, UserList, VariableRoute } from './02_react_advanced/07.Variable_Route'
...
import PokemonSearch from './02_react_advanced/practice/Pokemon'
  ...
  return (
    <>
      ...
      <Routes>
        ...
        // Axios 실습
        <Route path="axios" element={<PokemonSearch/>} />
        ...
        <Route path="*" element={
          <div>
            ...
            */}
            <Link to={"/"}>메인 페이지</Link>
            {/* <a href="/">a태그로 이동하기</a>  새로고침 되므로 좋지 못한 방식 */}
          </div>
        }/>
      </Routes>
