/*
    #1. Redux
     ...
     - redux는 "장바구니, 실시간 알림, 인증상태 및 권한"등을 관리하며 
     컴포넌트단위로 관리되어야 하는 일반 state는 redux로 관리하지 않는다
    ...
    5) Dispatch(Action전송 함수)
     ...
     - Dispatch를 통해 통해 Action이 전달되면 Action에서 정의한 type의 reducer가 호출된다
